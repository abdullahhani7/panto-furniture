    ...
    return (
        <div className='absolute top-0 left-0 z-10 pt-10 pb-10  w-full px-30'>
            <div className='lg:container mx-auto flex justify-center items-center w-full '>
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="logo_wrapper">
                        <Link to='/'><h3 className='text-2xl text-white font-medium capitalize'>Panto</h3></Link>
                    </div>
                    ...
                    <div className="header_right">
                        <button className='relative'><BsMinecartLoaded size='2rem' color='white' />
            ...
            <div className={`mobile_name ${isOpen && 'active'}`}>
                <button onClick={() => setIsOpen(false)} className='absolute top-10 right-5 cursor-pointer w-[50px] h-[50px] rounded-full border-[2px] border-black flex items-center justify-center'>
