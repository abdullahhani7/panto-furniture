            ...
            <div className="lg:container mx-auto">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <p className='text-base text-[#1e1e1e] font-medium'>The advantage ot hiring a workspace with us is that gives you comfortable service and all-around facilities</p>
                    </div>
