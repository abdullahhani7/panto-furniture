...
const Choose = () => {
  const chooseData = [
    ...
    },
    {
      ...
      description:
        "you can get a workspace of the highest quality at and affordable price and still enjoy the facilities that are oly here.",
    },
    {
      title: "Many Choices",
      description:
        ...
        <div className="grid md:grid-cols-3 gap-6 items-center">
          {chooseData?.map((item, indx) => (
            <div key={indx} className="space-y-4">
              <h3 className="text-2xl text-[#1e1e1e] font-bold capitalize">
                {item?.title}
              </h3>
              <p className="text-base text-[#e1e1e1e] font-normal">
                {item?.description}
              </p>
